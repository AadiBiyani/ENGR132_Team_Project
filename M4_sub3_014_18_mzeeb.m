function [Acc_Start_Time, Time_Constant] = M4_sub3_014_18_mzeeb (speedVec, timeVec, initialSpeed, finalSpeed)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ENGR 132 
% Program Description 
...
%
% Function Call
% M4_sub3_014_18_mzeeb (speedVec, timeVec, initialSpeed, finalSpeed)
%
% Input Arguments
