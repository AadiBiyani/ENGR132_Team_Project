function M2_main_014_18_wu2425()
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ENGR 132 
% Program Description 
...
[response_left, response_right] = M2_sub5_boundary_014_18_wu2425(time);

%% ____________________
%% CALCULATIONS

data_set = M2_sub2_014_18_biyania(data_set); % call subfunction 1

for a = 1:size(data_set, 2)
    % call subfunction 3
    [initialSpeed(a), finalSpeed(a)] = M2_sub4_014_18_fagan13(time, data_set(:,a));
    % call subfunction 2
    [Acc_Start_Time(a), Time_Constant(a)] = M2_sub3_014_18_mzeeb(data_set(:,a), time, initialSpeed(a), finalSpeed(a));
end
